 ...
 */
package com.benli.common.view.xListView;
...
/* Author: Jay
 * CreateTime: 2014年5月27日
 * Description: 为ListView实现滚动条监听接口（同时增加更新和加载历史面板）
 * */
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (getFirstVisiblePosition() == 0
                        && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)&&(flag==0||flag==1)&&mEnablePullRefresh) {
                    flag=1;
                    updateHeaderHeight(deltaY / OFFSET_RADIO);
                    invokeOnScrolling();
                } else if (getLastVisiblePosition() == mTotalItemCount - 1
                        && (mFooterView.getBottomMargin() > 0 || deltaY < 0)&&(flag==0||flag==2) && !(getFirstVisiblePosition() == 0
