...
public final class StorageUtils {
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            LogUtil.warn("Can't define system cache directory! '%s' will be used.", cacheDirPath);
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            ...
            try {
                ...
                LogUtil.info("Can't create \".nomedia\" file in application external cache directory");
            }
        }
        return appCacheDir;
    }
